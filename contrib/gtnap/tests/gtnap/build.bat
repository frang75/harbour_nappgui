...
::
:: Will generate the gtnap.exe demo application.
...
call %HBMK_PATH%\\hbmk2.exe %HBMK_FLAGS% -comp=%COMPILER% %CWD%\gtnap.hbp || goto error_gtnap
...
::
:error_gtnap
echo Error building GTNAP demo
goto end
