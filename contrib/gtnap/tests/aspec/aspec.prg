/* Modernized example of ASPEC applications using GTNAP-Forms */
///* encoding: cp850 */
#INCLUDE "ord.ch"
#INCLUDE "inkey.ch"
#INCLUDE "hbnap.ch"
...
// Desativar na "cuademo", para p�gina de c�digo ser a padr�o Windows/Linux
...
SET AUTOPEN OFF  // tornar a abertura do indice cdx n�o automatica
// Desativar na "cuademo", para p�gina de c�digo ser a padr�o Windows/Linux
// hb_cdpSelect("PT850")
...
// ADDOPCAO V_JANELA TEXTO "#menu de op��es" ;
...
// ADDOPCAO V_Janela TEXTO "exibi��o/edi��o de #texto em mem�ria" ;
//     ACAO EXEMPLO_TEXTO_MEMORIA() AJUDA "P06677"
// ADDOPCAO V_Janela TEXTO "exibi��o de #arquivo texto" ;
...
// N_Resposta = PERGUN("Cancelar digita��o dos dados ?",{"sim","nao"},2)
// IF N_Resposta == 1
//    L_Confirmacao = .T.
// ELSE
//    L_Confirmacao = .F.
