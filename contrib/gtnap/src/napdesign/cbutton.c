...
static void i_OnClick(CData *data, Event *e)
{
    ...
    comwin_color(window, tc(data->info), r2d.pos.x + r2d.size.width / 2, r2d.pos.y + r2d.size.height / 2, ekRIGHT, ekTOP, data->color, NULL, 0, listener(data, i_OnColorChange, CData));
}
