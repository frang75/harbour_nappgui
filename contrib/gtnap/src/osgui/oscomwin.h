...
_osgui_api const char_t *oscomwin_file(OSWindow *parent, const char_t **ftypes, const uint32_t size, const char_t *caption, const char_t *start_dir, const bool_t open);
